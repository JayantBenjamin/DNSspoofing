...
<div id="header"><div class="window clear">
	...
	<h1 class="hide-at-larger"> Wireless Guest Login</h1>
...
<div id="main"><div class="window">
	...
	<p class="smaller">The net Guest wireless network has limited bandwidth.  If you require additional bandwidth you will need a valid UNInet ID and connect to the wireless network (SSID): UNInet, UNInet 2.0 or UNInet 3.0.</p>
...
<form action="captiveportal2.php" method="post">
<input TYPE="hidden" NAME="buttonClicked" SIZE="16" MAXLENGTH="15" value="0">
<input TYPE="hidden" NAME="redirect_url" SIZE="255" MAXLENGTH="255" VALUE="">
<input TYPE="hidden" NAME="err_flag" SIZE="16" MAXLENGTH="15" value="0">
<div align="center">
<input id="input-button" NAME="username" size="25" maxlength="24" value="Enter Email">
<input TYPE="hidden" id="input-button" NAME="password" size="25" maxlength="24" value="Password">
<input type="submit" id="submit-button" name="Submit" value="Request OTP" class="button" onclick="submitAction();">
</div>
</form>
